...
-- download from  https://github.com/Hammerspoon/Spoons/raw/master/Spoons/SpoonInstall.spoon.zip as described at https://www.hammerspoon.org/Spoons/SpoonInstall.html
